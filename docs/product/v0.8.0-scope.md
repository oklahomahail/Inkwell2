# Inkwell v0.8.0 — Scope Plan

> **⚠️ HISTORICAL DOCUMENT** - This planning document is for reference only. v0.8.0 features were released as part of v0.9.0-beta. See [CHANGELOG.md](../../CHANGELOG.md) for actual release details.

**Branch Prefix:** `feat/v0.8.0-*`
**Timeline:** 3–4 weeks (target: mid–late November 2025)
**Status:** ✅ Completed (released as v0.9.0-beta)
