...
class ErrorBoundary extends Component<Props, State> {
  ...
  private handleGoHome = () => {
    this.setState({ hasError: false, error: null, errorInfo: null });
    // Use pathname from window.location to preserve any basePath and handle profiles route
    const pathname = window.location.pathname;
    const targetPath = pathname.split('/')[1] === 'profiles' ? '/' : '/profiles';
        ...
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div>
            ...
            {import.meta.env.MODE === 'development' && this.state.error && (
              <details className="text-left bg-red-100 rounded-lg p-4 text-sm mt-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 bg-red-200 text-red-700 rounded-lg hover:bg-red-300 transition-colors"
            >
  ...
  private renderFeatureError() {
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
        ...
        <h3 className="text-lg font-semibold text-red-900 mb-2">Feature Unavailable</h3>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium text-amber-900">Component Error</div>
            <div className="text-xs text-amber-700 mt-1">Unable to render this section</div>
          </div>
          <button
            onClick={this.handleRetry}
  ...
  <ErrorBoundary
    ...
    fallback={
      <div className="bg-slate-50 border-2 border-dashed border-slate-300 rounded-lg p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-700 mb-2">Editor Unavailable</h3>
    ...
    fallback={
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-medium text-purple-900">AI Assistant Unavailable</div>
  ...
  <ErrorBoundary
    ...
    fallback={
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
        ...
        <h3 className="text-lg font-semibold text-blue-900 mb-2">Analytics Unavailable</h3>
