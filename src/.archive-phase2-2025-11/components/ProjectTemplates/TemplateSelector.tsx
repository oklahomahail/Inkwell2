                  ...
                  >
                    ...
                    <div className="space-y-2 mb-3">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="text-slate-600">{template.estimatedLength}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        {selectedTemplate.characters.slice(0, 3).map((character, index) => (
                          <div
                            key={index}
                            className="text-xs text-slate-500 bg-white px-2 py-1 rounded flex items-center justify-between"
                          >
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg bg-white text-slate-900 text-sm resize-none"
