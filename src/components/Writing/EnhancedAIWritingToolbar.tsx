...
export default function EnhancedAIWritingToolbar({
  ...
  const performRealTimeAnalysis = useCallback(
    async (text: string) => {
      ...
      try {
        ...
        const response = await claudeService.sendMessage(analysisPrompt, { maxTokens: 3000 });
  ...
  const handleToneAdjustment = useCallback(
    async (targetTone: string) => {
      ...
      try {
        ...
        const response = await claudeService.sendMessage(tonePrompt, { maxTokens: 2000 });
  ...
  const handleEmotionEnhancement = useCallback(
    async (intensity: string) => {
      ...
      try {
        ...
        const response = await claudeService.sendMessage(emotionPrompt, { maxTokens: 2000 });
  ...
  const handleDialogueOptimization = useCallback(async () => {
    ...
    try {
      ...
      const response = await claudeService.sendMessage(dialoguePrompt, { maxTokens: 2500 });
  ...
  const handlePacingAnalysis = useCallback(async () => {
    ...
    try {
      ...
      const response = await claudeService.sendMessage(pacingPrompt, { maxTokens: 2500 });
    ...
    <div className="space-y-4">
      ...
      {selectedText && (
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
          <div className="text-xs text-gray-600 dark:text-gray-400 mb-2">Selected Text:</div>
                  ...
                  {Array.from({ length: 4 }, (_, i) => (
                    <div
                      ...
                      className={`w-2 h-2 rounded-full ${
                        i < level.intensity ? 'bg-rose-500' : 'bg-gray-300 dark:bg-gray-600'
                      }`}
                    />
                  ))}
                </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={isAnalyzing}
              className="flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-900/50 text-blue-800 dark:text-blue-200 rounded-lg text-sm transition-colors disabled:opacity-50"
            >
        ...
        {pacingResults && (
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Pacing Score:</span>
    ...
    <div className="space-y-4">
      <div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-indigo-100 dark:bg-indigo-900/30 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 text-indigo-800 dark:text-indigo-200 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 bg-green-100 dark:bg-green-900/30 hover:bg-green-200 dark:hover:bg-green-900/50 text-green-800 dark:text-green-200 rounded text-xs transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-900/50 text-blue-800 dark:text-blue-200 rounded text-xs transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-400 rounded text-xs transition-colors"
            >
              <X className="w-3 h-3" />
            </button>
          </div>
  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg ${className}`}
    >
      {/* Header */}
