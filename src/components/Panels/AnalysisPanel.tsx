  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold font-bold text-gray-900 dark:text-white">
          Writing Analytics
        </h1>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
        <h2 className="text-lg font-semibold font-semibold text-gray-900 dark:text-white mb-4">
          Recent Sessions
        </h2>
