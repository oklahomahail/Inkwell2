  ...
  SettingsPanel = () => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('h2', { className: 'text-2xl font-bold font-bold font-bold mb-4' }, 'Settings Panel'),
  ...
  AnalysisPanel = () => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('h2', { className: 'text-2xl font-bold font-bold font-bold mb-4' }, 'Analysis Panel'),
