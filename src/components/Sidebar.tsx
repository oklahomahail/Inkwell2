...
export default function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'fixed left-0 top-0 h-full bg-[color:var(--ink-sidebar-bg)] transition-[width] duration-200 border-r border-gray-200 flex flex-col',
    ...
    >
      ...
      <div className="border-b border-gray-200 overflow-hidden">
        ...
        <button
          ...
          className="absolute top-3 -right-3 h-6 w-6 rounded-full bg-white border border-gray-200 flex items-center justify-center shadow-sm hover:shadow-md transition-shadow"
