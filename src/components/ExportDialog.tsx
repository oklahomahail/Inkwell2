                ...
                return (
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1 text-left">
                      ...
                      <p className={`text-sm mt-1 ${isSelected ? 'text-blue-700 dark:text-blue-300' : 'text-gray-500 dark:text-gray-400'}`}>
                        {option.description}
                      </p>
                    </div>
                    {isSelected && (
              ...
              <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="include-metadata" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="include-synopsis" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="include-characters" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
