...
interface InkwellLoaderProps {
  size?: 'sm' | 'md' | 'lg';
}

export const InkwellLoader: React.FC<InkwellLoaderProps> = ({ size = 'md' }) => {
  const sizeClasses = {
    sm: 'w-6 h-6',
    md: 'w-8 h-8',
    lg: 'w-12 h-12',
...
interface InkwellWordmarkProps {
  size?: 'sm' | 'md' | 'lg';
  withIcon?: boolean;
  className?: string;
}

export const InkwellWordmark: React.FC<InkwellWordmarkProps> = ({
  size = 'md',
  withIcon = true,
  className = '',
}) => {
...
interface InkwellSaveIndicatorProps {
  saving?: boolean;
  saved?: boolean;
  className?: string;
}

export const InkwellSaveIndicator: React.FC<InkwellSaveIndicatorProps> = ({
  saving = false,
  saved = false,
  className = '',
}) => {
