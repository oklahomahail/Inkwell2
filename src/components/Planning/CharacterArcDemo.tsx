...
const sampleCharacters: GeneratedCharacter[] = [
  {
    ...
    role: 'protagonist',
    description:
      'A young mage struggling to control her growing powers while navigating the political intrigue of the Royal Academy. Born in a small village to humble farmers, Elena discovered her magical abilities when they saved her family from bandits.',
    motivation:
    ...
    relationships: [
      {
        ...
        type: 'ally',
        dynamics: 'Protective mentor figure who guides Elena',
        arcInfluence: 'major',
      },
      {
        withCharacter: 'Lord Shadowmere',
        type: 'enemy',
        dynamics: 'Primary antagonist who challenges her beliefs',
        arcInfluence: 'major',
      },
      {
        withCharacter: 'Professor Willowmere',
        type: 'mentor',
        dynamics: 'Wise teacher who reveals hidden truths',
        arcInfluence: 'moderate',
      },
      {
        withCharacter: 'Aria Moonwhisper',
        type: 'love_interest',
        dynamics: 'Romantic partner who provides emotional support',
        arcInfluence: 'moderate',
      },
    ],
    voiceProfile: {
    ...
    growthMoments: [
      {
        chapter: 1,
        scene: 'Scene 1',
        catalyst: 'Key event trigger',
        realization: 'First successful spell in combat',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        chapter: 2,
        scene: 'Scene 2',
        catalyst: 'Key event trigger',
        realization: 'Standing up to academy bullies',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 3',
        catalyst: 'Key event trigger',
        realization: 'Accepting leadership role',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 4',
        catalyst: 'Key event trigger',
        realization: 'Making the ultimate sacrifice',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
    ],
  },
  {
    ...
    role: 'supporting',
    description:
      "Elena's loyal friend and fellow student, a skilled swordsman from a military family. Son of a decorated general, Marcus chose the Academy over military service to his father's disappointment.",
    ...
    relationships: [
      {
        ...
        type: 'ally',
        dynamics: 'Complex interpersonal dynamics',
        arcInfluence: 'ally',
      },
      {
    ...
    growthMoments: [
      {
        ...
        scene: 'Scene 1',
        catalyst: 'Key event trigger',
        realization: 'First act of defiance against father',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 2',
        catalyst: 'Key event trigger',
        realization: 'Choosing friendship over family approval',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 3',
        catalyst: 'Key event trigger',
        realization: 'Leading a rescue mission',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
    ],
  },
  {
    ...
    role: 'antagonist',
    description:
      'A former academy professor turned cult leader, seeking to awaken an ancient evil for personal power. Once a respected scholar until his research into forbidden magic corrupted him.',
    ...
    growthMoments: [
      {
        ...
        scene: 'Scene 1',
        catalyst: 'Key event trigger',
        realization: 'First use of forbidden magic',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 2',
        catalyst: 'Key event trigger',
        realization: 'Betraying former colleagues',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 3',
        catalyst: 'Key event trigger',
        realization: 'Embracing full corruption',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 4',
        catalyst: 'Key event trigger',
        realization: 'Final desperate gambit',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
    ],
  },
  {
    ...
    role: 'supporting',
    description:
      "A talented healer and Elena's romantic interest, torn between her pacifist beliefs and the need to fight. Raised in a peaceful monastery, Aria came to the Academy to learn healing magic.",
    ...
    growthMoments: [
      {
        ...
        scene: 'Scene 1',
        catalyst: 'Key event trigger',
        realization: 'First time using magic to harm',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 2',
        catalyst: 'Key event trigger',
        realization: 'Saving Elena despite personal cost',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 3',
        catalyst: 'Key event trigger',
        realization: 'Teaching others defensive healing',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
  ...
  },
  {
    ...
    role: 'supporting',
    description:
      "Elena's wise mentor and Head of Magical Studies, hiding secrets about the academy's past. A former adventurer who settled into teaching after a traumatic encounter with dark magic.",
    ...
    growthMoments: [
      {
        ...
        scene: 'Scene 1',
        catalyst: 'Key event trigger',
        realization: 'Deciding to train Elena',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 2',
        catalyst: 'Key event trigger',
        realization: 'Revealing academy secrets',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
      {
        ...
        scene: 'Scene 3',
        catalyst: 'Key event trigger',
        realization: 'Facing Shadowmere again',
        actionChange: 'Behavioral shift following realization',
        impact: 'moderate',
      },
    ],
