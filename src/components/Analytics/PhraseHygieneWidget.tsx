// src/components/Analytics/PhraseHygieneWidget.tsx
...
interface PhraseHygieneWidgetProps {
  className?: string;
  showTitle?: boolean;
  maxItems?: number;
}
...
export const PhraseHygieneWidget: React.FC<PhraseHygieneWidgetProps> = ({
  ...
  if (!currentProject) {
    return (
      <div className={`${className} p-4 bg-white dark:bg-gray-800 rounded-lg border`}>
        {showTitle && (
      ...
      {showTitle && (
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-medium text-gray-900 dark:text-white">Phrase Hygiene</h3>
          </div>
          <button
        ...
        <>
          ...
          <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded text-sm">
            <div className="flex justify-between items-center mb-1">
              <span className="text-gray-600 dark:text-gray-400">Total words analyzed:</span>
          ...
          {offenders.length === 0 ? (
            ...
            <div className="space-y-2 max-h-80 overflow-y-auto">
              {offenders.map((offender, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-2 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
                >
